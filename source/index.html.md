...
读取  | 账户接口 |  通用   | /linear-swap-api/v1/swap_sub_account_info_list                       | POST    |      【逐仓】批量获取子账户资产信息                      |       是          |
读取  | 账户接口 |  通用   | /linear-swap-api/v1/swap_cross_sub_account_info_list                 | POST    |      【全仓】批量获取子账户资产信息                     |       是          |
...
读取  | 交易接口 |  通用   | /linear-swap-api/v1/swap_matchresults_exact                          | POST    |      【逐仓】组合查询用户历史成交记录                     |       是          |
...
读取  | 交易接口 |  通用   | /linear-swap-api/v1/swap_cross_hisorders_exact                       | POST    |      【全仓】组合查询合约历史委托                        |       是          |
读取  | 交易接口    |  全仓  |  /linear-swap-api/v1/swap_cross_matchresults                          | POST    |     【全仓】获取用户的合约历史成交记录         |       是          |
读取  | 交易接口 |  通用   | /linear-swap-api/v1/swap_cross_matchresults_exact                    | POST    |      【全仓】组合查询用户历史成交记录                     |       是          |
