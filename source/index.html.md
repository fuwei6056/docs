...
```json
{
	...
	"data": [{
		...
		"list": [{          //ladder data, sort by lever rate, the smaller the value, the higher the position
			"lever_rate": 5,     
			"ladders": [{           // sort by min margin balance, the smaller the value, the higher the position
